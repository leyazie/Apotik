      ...
      <section id="obat-umum" class="kategori-obat">
         ...
         <div class="obat-list">
            <div class="obat-item">
               ...
               <p>Rp 14.000</p>
               <a href="./keranjang.php"> <button type="button" class="bi bi-basket" >keranjang</button></a>
               <button class="btn-beli"><i class="bi bi-wallet2"></i> Beli</button>
            </div>
            <div class="obat-item">
               ...
               <p>Rp 3.100</p>
               <a href="./keranjang.php"> <button type="button" class="bi bi-basket" >keranjang</button></a>
               <a href="./login.php"><button type="button" class="btn-beli bi bi-wallet2"> Beli</button></a>
            </div>
            <div class="obat-item">
      ...
      <section id="obat-resep-dokter" class="kategori-obat" style="display:none;">
         ...
         <div class="obat-list">
            <div class="obat-item">
               ...
               <p>Rp 151.700</p>
               <a href="./keranjang.php"> <button type="button" >Resep Dokter</button></a>
            </div>
            <div class="obat-item">
