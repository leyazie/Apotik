...
switch (isset($_SESSION['level'])) {
    case 'admin':
        header('location: apotikadmin/homeadmin.php');
        break;
    case 'user':
        ...
        <div class="w-80 bg-[#f5f5dc] p-6 rounded-lg shadow-lg">
            ...
            <form method="post">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center border-b border-[#7a6e5d] py-2">
                        <input class="appearance-none bg-transparent border-none w-full text-[#7a6e5d] mr-3 py-1 px-2 leading-tight focus:outline-none" type="password" name="password" placeholder="Password" />
