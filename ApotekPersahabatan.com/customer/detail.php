...
<body>
      ...
      <section class="flex space-x-8 bg-white rounded-lg p-4">
         <div class="w-2/3">
            ...
            <div class="flex space-x-4">
               ...
               <div>
                  ...
                  <p class="text-2xl font-bold text-red-600 mt-2" id="price">Rp. 13.860,-</p>
                  <div class="mt-4">
         ...
         <div class="w-1/3 mt-24">
            <div class="bg-white p-4 rounded-lg shadow-lg">
               ...
               <button class="bg-yellow-500 text-white w-full py-2 rounded mb-2"><a href="./detailpembayaran.php">Beli</a></button>
            </div>
         </div>
      </section>
   </main>
   ...
   <script>
      const pricePerUnit = 13860; // Price in IDR
      let quantity = 1;
      ...
      document.getElementById('increaseBtn').addEventListener('click', () => {
         if (quantity < 100) { // Assuming stock limit
            quantity++;
            updateDisplay();
         }
      });
